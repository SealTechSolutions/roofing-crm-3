...
export default function ProjectPhotos({ dealId, dealTitle }) {
  ...
  /**
   * NOTE: The Roof Condition Report was retired in Feb 2026 — the customer-
   * facing report now flows through the Assessment → Basic Evaluation PDF
   * (see the deal's Assessment ▾ action bar button). This kept only the
   * chronological Timeline PDF for internal / adjuster use.
   */
